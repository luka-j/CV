...
\def\ribbonSwing{\ribbon{blue}{Swing}}
...
{\contentFont Productivity and collaboration app for groups of students attending the same school. Provides a streamlined way for collecting and sharing notes, questions and multimedia content for different courses. Includes course organizer and exam calendar. The app won \nth{2} prize at Sixth mt:s App competition.}
\end{minipage}\newline%
%
\begin{minipage}[t]{\linewidth}\vspace{\subsectionSpace}
...
{\contentFont Three apps designed to work together in order to collect and interpret data about Serbian primary schools. I've built a scraper which collects students’ grades, graduation exam results and wishlists, enrolment simulator with custom rules support, SQL-like data plotting language, web frontend for plots, performant plotter in Swing (able to plot hundreds of thousands of points and efficiently add points or resize panel) and a desktop point-and-click interface for constructing queries. Data and code is freely available on my GitHub.}
\end{minipage}\newline%
% TODO Chat Surveys (RAF Hakaton)
% TODO Video compressor
% TODO (maybe?) Lab inventory
% TODO CV
% End left column
\end{minipage}
\end{document}